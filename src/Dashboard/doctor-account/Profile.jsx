...
function Profile({doctorData}) {
    ...
    const handleQualificationonChange = (event, index)=>{
    ...
    const handleExperienceonChange = (event, index)=>{
    ...
    const handleTimeSlotonChange = (event, index)=>{
    ...
    <div>
        ...
        <form>
            ...
            <div className='mb-5'>
                ...
                placeholder='Email' className='form__input' readOnly aria-readonly disabled/>
            </div>
            <div className='mb-5'>
            ...
            <div className='mb-5'>
                ...
                {formData.qualifications?.map((item,index)=>(
                    <div key={index}>
                        <div>
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    ...
                                    onChange={e=> handleQualificationonChange(e,index)}
                                    />
                                </div>
                        ...
                        text-[18px] mt-2 mb-[30px] cursor-pointer'>
                            <AiOutlineDelete/>
                        </button>     
                    </div>
                    )
                        ...
                        <div>
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    ...
                                    value={item.startingDate}
                                    className='form__input'
                                    onChange={e=>handleExperienceonChange(e,index)}
                                    />
                                </div>
                        ...
                        <div>
                            <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                                <div>
                                    ...
                                    <select onChange={e=>handleTimeSlotonChange(e,index)}
                                ...
                                <div>
                                    ...
                                    className='form__input'
                                    onChange={e=>handleTimeSlotonChange(e,index)}
                                    />
                                </div>
            ...
            <div className="mb-5 flex items-center gap-3">
                { formData.photo && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center
                    justify-center'>
                <img src={formData.photo} className='rounded-full w-full' alt="" />
                </figure>}
            ...
            <div className="mt-7">
                <button type='submit' onClick={updateProfileHandler} className='bg-primaryColor text-white 
