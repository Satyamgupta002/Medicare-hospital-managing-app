            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam at placeat odio maiores assumenda sint excepturi, quibusdam tempore accusamus praesentium incidunt nihil reprehenderit eaque magni. Sunt minus qui quos nemo!
                </p>
              ...
              <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
                <div>
                  <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] fomt-[700] text-headingColor'>
                    30+
                  </h2>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className="mt-[30px]">
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                  World-class care for everyone. Our health system offer unmatched, expert health care. From this lab to the clinic.
                </p>
