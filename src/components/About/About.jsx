            ...
            flex-col lg:flex-row'>
                ...
                <div className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2'>
                    ...
                    <p className="text__para mt-[30px]">
                        ...
                        not looking back at what we accomplished but towards what we can do tomorrow.
                        Providing the best. Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
                        Veritatis nulla nobis nesciunt a fuga autem? Animi iure blanditiis distinctio.
                    </p>
